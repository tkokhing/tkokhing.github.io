---
title: "Abstraction - is it still relevant?"
excerpt: "Abstraction in software engineering has been challenged with the rise of machine learning (ML). While ML introduces new paradigms and tools, the concept of abstraction, which is taught at the foundational level of software engineering, continues to play a vital role in developing, managing, and scaling systems. Here’s why:"
coverImage: "/assets/topics/abstraction/abstraction.png"
date: "2024-08-19T11:39:17.122Z"
author:
  name: tkokhing
  picture: "/img/logo/tkokhing.gif"
ogImage:
  url: "/assets/topics/abstraction/abstraction.png"
