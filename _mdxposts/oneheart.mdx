---
title: "OneHeart Crowdfunding Project (Hyperledger Fabric Blockchain)"
excerpt: "Crowdfunding is a method of raising funds by asking the public for donations, whether small or large amounts. This project aims to develop a new business process using blockchain technology. Given the importance of traceability and transparency, a permissioned blockchain, such as Hyperledger Fabric, was utilized. IBM Cloud was chosen as the ideal platform due to its seamless integration with various architectures and its scalability."
coverImage: "/assets/topics/oneheart/oneheart.png"
date: "2021-08-21T22:21:10.142Z"
author:
  name: tkokhing
  picture: "/img/logo/tkokhing.gif"
ogImage:
  url: "/assets/topics/oneheart/oneheart.png"
subPath: "mdxtester/AtoZ"
---

## OneHeart Crowdfunding Project [(Hyperledger Fabric Blockchain)](https://hyperledger-fabric.readthedocs.io/)
...
## Abstraction pic below
![](https://tkokhing.github.io/assets/topics/abstraction/abstraction.png)
...
![](https://github.com/tkokhing/OneHeart/blob/main/images/prototype_snapshoot.gif)
...
![](https://github.com/tkokhing/OneHeart/blob/main/images/business_process-blockchain.gif)
...
![](https://github.com/tkokhing/OneHeart/blob/main/images/features_and_security.png)
...
![](https://github.com/tkokhing/OneHeart/blob/main/images/k8s_deployment.gif)
...
![](https://github.com/tkokhing/OneHeart/blob/main/images/inside_OneHeartBlockchain.gif)

* As you add more CAs and Peers, do also check that their Identities are correspondingly created in the Wallet tab

![](https://github.com/tkokhing/OneHeart/blob/main/images/check_identities.gif)
...
![](https://github.com/tkokhing/OneHeart/blob/main/images/channel_details.gif)



Article was first published in 2021 on my [OneHeart](https://github.com/tkokhing/OneHeart/blob/main/README.md) project repo.
