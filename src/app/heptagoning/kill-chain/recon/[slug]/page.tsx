...
// import { VICTIM1_IP, VICTIM1_PORT } from "@/lib/share/constants";
...
// import { RECON_Site } from "@/lib/_data_exporter/data_kiil-chain/kill-chain_exporter";
//
...
// import { gobusterComponents, nmapComponents, reconsiteComponents, rustscanComponents,sqlComponents } from "@/lib/_data_exporter/pipeline/imported_mdx_components";
...
export default async function Post(props: Params) {
  ...
  const ImportComponents = {
    RECON_Site,  //  render by [slug]page recon_site.mdx as <RECON_Site /> || will not have impact inside mdx-components.tsx
    NMAP_Overview,
    NMAP_Vuln_Scan,
    NMAP_SMB_Enum,
    NMAP_TCP_vs_UDP,
      ...
      <Container>
        <ToggleAllFrame>
          <article className="mb-32">
            ...
            {/* <PostBody content={post.content} components={{...ImportComponents, ...gobusterComponents, ...nmapComponents, ...reconsiteComponents, ...rustscanComponents, ...sqlComponents}}/> */}
